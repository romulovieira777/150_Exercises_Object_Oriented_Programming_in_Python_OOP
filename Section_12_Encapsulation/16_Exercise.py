...
Implement a class named TechStack that has one protected instance attribute named tech_names. Then, using the @property
decorator, create a property named tech_names (read, modify, and delete property, without validation).

Create an instance of the class named tech_stack and the tech_names attribute value:

    - 'python,java,sql'

Print the contents of the tech_names attribute. Then, modify this attribute to value:
...
Print the contents of the __dict__ attribute of the tech_names instance to the console.
...
class TechStack:
    def __init__(self, tech_names: str):
