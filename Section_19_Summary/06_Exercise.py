...
The Note class is given. Implement a find() method that checks if a given word is in the note (case insensitive). The
method should return True or False, respectively.
