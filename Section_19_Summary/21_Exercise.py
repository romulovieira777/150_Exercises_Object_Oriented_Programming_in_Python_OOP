...
The implementation of the classes: Product and Warehouse is given. Add a method to the Warehouse class named
display_products() that displays all products in the products attribute of the Warehouse class.
